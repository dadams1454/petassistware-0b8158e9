...
import { Eye, Pencil, Trash2, Female, Male } from 'lucide-react';
...
const DogsList = ({ dogs, onView, onEdit, onDelete }: DogsListProps) => {
  ...
  return (
    <div>
      {renderDogGroup(groupedDogs.females, "Females", <Female className="h-5 w-5 text-pink-500" />)}
      {renderDogGroup(groupedDogs.males, "Males", <Male className="h-5 w-5 text-blue-500" />)}
